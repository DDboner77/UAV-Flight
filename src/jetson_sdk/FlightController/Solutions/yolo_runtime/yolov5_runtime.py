...
class Detector():
    ...
    def init_model(self):
        ...
        print("ONNX Runtime available providers:", avail)
        if self.dml and 'CUDAExecutionProvider' in avail:
            providers = ['CUDAExecutionProvider','CPUExecutionProvider']
        elif self.dml and 'TensorrtExecutionProvider' in avail:
...
class camera:
    ...
    def __init__(self) -> None:
        try:
            ...
            self.video_writer = cv2.VideoWriter(
                'output.avi', fourcc, self.fps, (self.width, self.height)
            )
        except:
            print("摄像头异常")
    ...
    def get_frame(self):
        try:
            ...
            self.video_writer.write(frame)  # 写入视频文件
            return frame
        except:
            print("摄像头异常")
            return None
